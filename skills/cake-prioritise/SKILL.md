...
5. For every quantified Rhythm, read `progress`: report completed and remaining load for its exact Monday–Sunday period. Every Rhythm is reviewed on a Monday–Sunday week; `Daily` means seven named day items, not a one-day checklist. Each checked item in the current Cake-managed checklist is one completed occurrence. `needs_sync` means the checklist has not yet been prepared or reconciled for that week; do not infer completion elsewhere.
...
- A recurring occurrence that becomes due again substantially unchanged is a Rhythm, not a Slice. Keep one persistent Rhythm card with Cadence, Load, and Supports; do not generate daily or weekly Plate cards. Cake manages one checklist named `Cake · <Monday–Sunday period>` on that card. Daily habits automatically receive Monday through Sunday items, and all Rhythm boxes may be checked together at the end of the week. Current-week sync preserves checked boxes; an approved new-week rollover reuses the checklist and resets them. A bounded effort to establish or materially change the Rhythm may still be a Cake and Slice.
